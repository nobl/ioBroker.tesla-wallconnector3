...
const state_attr = {
	...
	"wifi_status.wifi_signal_strength": { name: "WiFi Signal Strength" },
	"wifi_status.wifi_rssi": { name: "WiFi RSSI", unit: "dBm" },
	...
	"vitals.evse_not_ready_reasons": { name: "EVSE not ready Reasons", role: "json" },
	...
	"vitals.current_alerts": { name: "Current Alerts", role: "json" },
	"vitals.power_w": { name: "Charging Power (calculated)", role: "value.power", unit: "W" },
